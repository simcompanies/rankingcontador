...
function renderAnalisesRankBoard(){
  ...
  board.innerHTML = obterTodasDivisoes().map(div => `
    <div class="division" data-div-id="${div.id}" style="--div-accent:var(${div.cor || '--muted'})">
      <div class="division-head"><div><div class="division-title">${div.titulo}</div><div class="division-range filtro-resultado-label" id="filtro-label-${div.id}"></div></div></div>
