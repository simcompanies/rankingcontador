...
ok('SW só remove caches com prefixo próprio', /startsWith\(CACHE_PREFIX\)/.test(sw));
ok('Conteúdo está embutido no index consolidado', htmlIndex.includes('id=\"view-conteudo\"'));
